...
class TessellationTests(unittest.TestCase):
    ...
    def test_inputs(self):
        ...
        self.assertRaises(NotImplementedError, Tessellation, points=g_points, attributes=None, crs=0)
        self.assertRaises(ValueError, Tessellation, points=g_points, attributes=list())
        self.assertRaises(ValueError, Tessellation, points=g_points, attributes=b_attrib.reshape(1, 1, -1))
