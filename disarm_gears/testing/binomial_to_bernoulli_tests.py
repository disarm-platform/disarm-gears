...
class BinomialToBernoulliTests(unittest.TestCase):
    ...
    def test_inputs(self):
        ...
        self.assertRaises(AssertionError, binomial_data_to_bernoulli, y=bad_y,
                          n_trials=good_n_trials)
        self.assertRaises(AssertionError, binomial_data_to_bernoulli, y=good_y,
    ...
    def test_outputs(self):
        ...
        output_1 = binomial_data_to_bernoulli(y=good_y, n_trials=good_n_trials,
                                              X=good_X)
